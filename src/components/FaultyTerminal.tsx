...
void main() {
    ...
    if(uSpotlightOpacity > 0.0){
      ...
      float spot = 1.0 - smoothstep(r * (1.0 - uSpotlightSoftness), r, d);
...
export default function FaultyTerminal({
  ...
  useEffect(() => {
    ...
    const update = (t: number) => {
      ...
      // Smooth mouse for both digit interaction and spotlight
    ...
    // Listen on window so it works even with content layered on top
